...
.data
key_array:	.word	0x1C, 0x1b, 0x23, 0x2B, 0x34, 0x33   	# define as many keycodes here as you need
		.word	0xF01C, 0xF01B, 0xF023, 0xF02B, 0xF034, 0xF033
num_keys:	.word	12					# put the length of the key_array here
