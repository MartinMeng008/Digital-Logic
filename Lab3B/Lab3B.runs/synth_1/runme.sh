...
HD_PWD='C:/Labs-in-Vivado/COMP541/Lab3B/Lab3B.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hexcounterdisplay.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hexcounterdisplay.tcl
