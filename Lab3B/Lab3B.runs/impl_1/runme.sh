...
HD_PWD='C:/Labs-in-Vivado/COMP541/Lab3B/Lab3B.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hexcounterdisplay.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hexcounterdisplay.tcl -notrace
